...
export const metadata: Metadata = {
  title: "Schilderwerk Binnen & Buiten | ARIX-SCHILDERSBEDRIJF Barneveld",
  description:
  ...
  keywords: [
    "schilderwerk Barneveld",
    "binnenschilderwerk",
    "buitenschilderwerk",
    "schilder woning",
    "schilder bedrijfspand",
    "schilderwerk Amersfoort",
    "schilderwerk Ede",
  ],
  openGraph: {
    type: "website",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Professioneel schilderwerk binnen en buiten door ARIX-SCHILDERSBEDRIJF",
      },
    ],
  },
  twitter: {
...
const serviceSchema = {
  ...
  description:
    "Professioneel binnen- en buitenschilderwerk voor woningen en bedrijfspanden in Barneveld en omgeving.",
  provider: {
    "@type": "LocalBusiness",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "Schilderwerk",
      item: "https://arix-schildersbedrijf.nl/diensten/schilderwerk",
    },
  ],
};
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative h-64 sm:h-80 rounded-2xl overflow-hidden shadow-lg">
                <Image
                  ...
                  alt="Professioneel binnenschilderwerk door ARIX-SCHILDERSBEDRIJF"
                  fill
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div className="relative h-64 sm:h-80 flex items-center justify-center">
                <Image
                  ...
                  alt="Illustratie van professioneel schilderwerk"
                  width={300}
                  height={300}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative h-64 sm:h-80 rounded-2xl overflow-hidden shadow-lg">
                <Image
                  ...
                  alt="Spuitwerk resultaat door ARIX-SCHILDERSBEDRIJF"
                  fill
                  className="object-cover"
                  sizes="(max-width: 1024px) 100vw, 50vw"
                />
